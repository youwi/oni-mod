...
namespace MeteorChangeMod
{
    internal class STRINGS
    {
        public class UI
        {
            ...
            {
                public static LocString BUTTONTEXT = (LocString)"Change Meteor Settings";
                public static LocString CHANGEWARNING = (LocString)"Most of these changes require a reload!";
